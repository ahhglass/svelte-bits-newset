...
export const DOC_PAGE_REGISTRY: Record<string, DemoLoader> = {
	...
	'button': () => import('./ButtonDemo.svelte'),
	...
	'fluid-interaction-cursor': () => import('./FluidInteractionCursorDemo.svelte'),
	'flowing-contact-info': () => import('./FlowingContactInfoDemo.svelte'),
	'digital-hover-image': () => import('./DigitalHoverImageDemo.svelte'),
	...
	'card-nav-v2': () => import('./CardNavV2Demo.svelte'),
	'card-swap': () => import('./CardSwapDemo.svelte'),
	'carousel': () => import('./CarouselDemo.svelte'),
	'cinematic-slider': () => import('./CinematicSliderDemo.svelte'),
	'distortion-slider': () => import('./DistortionSliderDemo.svelte'),
	'pixelated-video-hover': () => import('./PixelatedVideoHoverDemo.svelte'),
	'scroll-triggered-footer-animation': () => import('./ScrollTriggeredFooterAnimationDemo.svelte'),
	'animated-cards-way-too-bouncy': () => import('./AnimatedCardsWayTooBouncyDemo.svelte'),
	...
	'draggable-pill-nav': () => import('./DraggablePillNavDemo.svelte'),
	...
	'scrambling-ascii': () => import('./ScramblingASCIIDemo.svelte'),
